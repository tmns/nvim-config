return {
	...
	config = function()
		...
		vim.keymap.set("n", "ghs", fzf.git_status, { desc = "Git status" })
		vim.keymap.set("n", "ghc", fzf.git_commits, { desc = "Git commits" })
		vim.keymap.set("n", "ghb", fzf.git_branches, { desc = "Git branches" })
		vim.keymap.set("n", "ghx", fzf.git_stash, { desc = "Git stash" })
	end,
}
